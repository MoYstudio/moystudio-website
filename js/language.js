...
const supportedLanguages = {
    'zh_cn': {
        name: '中文',
        title: {
            index: 'MoY工作室 | 官网开放 | 倒计时\xa0\xa0\xa0\xa0\xa0',
            jump: 'MoY Studio | ( •̀ ω •́ )✧ | 跳转！\xa0\xa0\xa0\xa0\xa0',
            error: 'OvO，你迷路了...\xa0\xa0\xa0\xa0\xa0'
        }
    },
    'en_us': {
        name: 'English(US)',
        title: {
            index: 'MoY Studio | The official website is open | countdown\xa0\xa0\xa0\xa0\xa0',
            jump: 'MoY Studio | ( •̀ ω •́ )✧ | JUMPING!\xa0\xa0\xa0\xa0\xa0',
            error: 'OvO, U Lost...\xa0\xa0\xa0\xa0\xa0'
        }
    },
    'ru_ru': {
        name: 'Русский',
        title: {
            index: 'MOY Студия | Официальный сайт открыт | отсчёт\xa0\xa0\xa0\xa0\xa0',
            jump: 'MoY Studio | ( •̀ ω •́ )✧ | Прыгать!\xa0\xa0\xa0\xa0\xa0',
            error: 'OvO, Вы потерялись...\xa0\xa0\xa0\xa0\xa0'
        }
    }
};
